...
```css filename="defaults.css" line_numbers="true" line_number_start="1" line_highlights="2"
/* Import a font */
...
```css filename="defaults.css" line_numbers="true" line_number_start="4" line_highlights="7"
:root {
...
```css filename="style.css" line_numbers="true" line_number_start="1" line_highlights="11"
body {
